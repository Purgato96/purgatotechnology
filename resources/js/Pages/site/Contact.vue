...
const contactLinks = {
    ...
    whatsapp: "https://wa.me/+5519993492828", // Substitua "seunumerodetelefone" pelo número no formato internacional (ex.: 5511999999999)
};
const features = [
    {
        name: 'Email',
        description:
            'Entre em contato por e-mail para dúvidas, suporte ou solicitações personalizadas.',
