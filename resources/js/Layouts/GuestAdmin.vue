  ...
  <div class="flex h-screen bg-gray-100">
    ...
    <aside class="w-64 bg-gray-800 text-white flex flex-col">
      ...
      <nav class="flex-1 px-2 space-y-2">
        ...
        <a href="/users" class="block px-4 py-2 rounded hover:bg-gray-700">Usuários</a>
        <a href="/settings" class="block px-4 py-2 rounded hover:bg-gray-700">Configurações</a>
      </nav>
    </aside>
