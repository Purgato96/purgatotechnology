  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Head, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title data-v-bb6d7070${_scopeId}>Guia Completo de SEO</title><meta name="description" content="Domine o SEO e aumente seu tráfego orgânico com nosso guia completo." data-v-bb6d7070${_scopeId}><meta head-key="keywords" name="keywords" content="tráfego orgânico, Domine o SEO, SEO, performance, Purgato Technology, tecnologia, sites rápidos, otimização, segurança, inovação, laravel, vue, tailwind" data-v-bb6d7070${_scopeId}><meta head-key="author" name="author" content="Matheus Purgato, Desenvolvedor Laravel e Especialista em SEO" data-v-bb6d7070${_scopeId}>`);
          } else {
            return [
      ...
      _push(`<div class="min-h-screen bg-gradient-to-b from-white to-gray-50 text-gray-900" data-v-bb6d7070><header class="text-center py-16 bg-gradient-to-br from-blue-600 to-sky-400 text-white" data-v-bb6d7070><h1 class="text-5xl font-extrabold tracking-tight leading-tight" data-v-bb6d7070> SEO Para Quem Faz: Um Guia Direto e Completo para Programadores, Técnicos e Empreendedores </h1><p class="mt-4 text-lg font-light max-w-3xl mx-auto" data-v-bb6d7070> Aprenda as melhores estratégias de SEO para dominar os buscadores e aumentar sua presença online. </p><a${ssrRenderAttr("href", paymentLink)} class="mt-8 inline-block px-8 py-4 bg-emerald-400 text-black font-bold rounded-lg shadow-lg text-lg hover:bg-emerald-500 hover:scale-105 transition transform" data-v-bb6d7070> Comprar Agora por R$ ${ssrInterpolate(price)}</a></header><section class="py-12 bg-gray-100" data-v-bb6d7070><h2 class="text-3xl font-semibold text-center" data-v-bb6d7070>O que tem neste e-book?</h2><div class="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto" data-v-bb6d7070><div class="p-6 bg-white rounded-lg shadow-md" data-v-bb6d7070><h3 class="text-xl font-bold mb-2" data-v-bb6d7070>✅ Fundamentos do SEO</h3><p class="text-gray-600" data-v-bb6d7070> Descubra como funciona o algoritmo do Google e a importância do SEO para melhorar a visibilidade do seu site. </p></div><div class="p-6 bg-white rounded-lg shadow-md" data-v-bb6d7070><h3 class="text-xl font-bold mb-2" data-v-bb6d7070>✅ SEO On-Page</h3><p class="text-gray-600" data-v-bb6d7070> Saiba como otimizar o conteúdo do seu site, desde títulos até meta descriptions, para obter melhores resultados nos buscadores. </p></div><div class="p-6 bg-white rounded-lg shadow-md" data-v-bb6d7070><h3 class="text-xl font-bold mb-2" data-v-bb6d7070>✅ SEO Off-Page</h3><p class="text-gray-600" data-v-bb6d7070> Aprenda estratégias para construir backlinks de qualidade e aumentar sua autoridade perante o Google. </p></div><div class="p-6 bg-white rounded-lg shadow-md" data-v-bb6d7070><h3 class="text-xl font-bold mb-2" data-v-bb6d7070>✅ Pesquisa de Palavras-Chave</h3><p class="text-gray-600" data-v-bb6d7070> Descubra como encontrar as melhores palavras-chave para ranquear suas páginas com eficiência. </p></div><div class="p-6 bg-white rounded-lg shadow-md" data-v-bb6d7070><h3 class="text-xl font-bold mb-2" data-v-bb6d7070>✅ SEO Técnico</h3><p class="text-gray-600" data-v-bb6d7070> Saiba como melhorar a indexação, estruturar URLs adequadas, aumentar a velocidade do site e corrigir erros de SEO. </p></div><div class="p-6 bg-white rounded-lg shadow-md" data-v-bb6d7070><h3 class="text-xl font-bold mb-2" data-v-bb6d7070>✅ Táticas Avançadas</h3><p class="text-gray-600" data-v-bb6d7070> Utilize hacks e estratégias avançadas para melhorar o tráfego orgânico rapidamente. </p></div><div class="p-6 bg-white rounded-lg shadow-md" data-v-bb6d7070><h3 class="text-xl font-bold mb-2" data-v-bb6d7070>✅ SEO para YouTube e Redes Sociais</h3><p class="text-gray-600" data-v-bb6d7070> Aprenda como otimizar seus vídeos e publicações para alcançar mais visualizações e engajamento. </p></div></div></section><section class="py-12 px-6 max-w-5xl mx-auto" data-v-bb6d7070><h2 class="text-3xl font-bold text-center text-gray-700" data-v-bb6d7070>O que você vai aprender?</h2><div class="mt-8 grid md:grid-cols-2 lg:grid-cols-4 gap-6" data-v-bb6d7070><div class="p-6 bg-white shadow-md rounded-lg text-center" data-v-bb6d7070><span class="text-blue-600 text-2xl font-bold" data-v-bb6d7070>1</span><p class="mt-2" data-v-bb6d7070>SEO On-Page e Off-Page</p></div><div class="p-6 bg-white shadow-md rounded-lg text-center" data-v-bb6d7070><span class="text-blue-600 text-2xl font-bold" data-v-bb6d7070>2</span><p class="mt-2" data-v-bb6d7070>Técnicas avançadas de palavras-chave</p></div><div class="p-6 bg-white shadow-md rounded-lg text-center" data-v-bb6d7070><span class="text-blue-600 text-2xl font-bold" data-v-bb6d7070>3</span><p class="mt-2" data-v-bb6d7070>Estratégias eficazes de Link Building</p></div><div class="p-6 bg-white shadow-md rounded-lg text-center" data-v-bb6d7070><span class="text-blue-600 text-2xl font-bold" data-v-bb6d7070>4</span><p class="mt-2" data-v-bb6d7070>Evite penalizações do Google</p></div></div></section><section class="py-12 bg-gray-100 text-center" data-v-bb6d7070><h2 class="text-3xl font-semibold" data-v-bb6d7070>Para quem é este e-book?</h2><p class="mt-4 text-lg max-w-2xl mx-auto" data-v-bb6d7070> Ideal para empreendedores, criadores de conteúdo e profissionais de marketing que desejam dominar o SEO! </p></section><section class="py-12 px-6 max-w-9xl mx-auto text-center" data-v-bb6d7070><h2 class="text-3xl font-bold text-gray-700" data-v-bb6d7070>O que nossos leitores dizem?</h2><div class="mt-8 grid gap-6 sm:grid-cols-1 md:grid-cols-3" data-v-bb6d7070><!--[-->`);
      ssrRenderList(testimonials, (testimonial, index) => {
        _push(`<div class="p-6 bg-white rounded-lg shadow-md" data-v-bb6d7070><p class="italic text-gray-600" data-v-bb6d7070>&quot;${ssrInterpolate(testimonial.text)}&quot;</p><p class="mt-3 text-sm font-semibold text-gray-900" data-v-bb6d7070>- ${ssrInterpolate(testimonial.name)}</p></div>`);
      });
      _push(`<!--]--></div></section><section class="py-12 bg-gray-100" data-v-bb6d7070><h2 class="text-3xl font-semibold text-center" data-v-bb6d7070>Perguntas Frequentes (FAQs)</h2><div class="mt-10 max-w-4xl mx-auto space-y-6" data-v-bb6d7070><details class="group" data-v-bb6d7070><summary class="flex justify-between items-center p-4 bg-white rounded-lg shadow-md cursor-pointer text-lg font-medium group-hover:bg-gray-50" data-v-bb6d7070> Como o e-book será entregue? <span class="transition-transform transform group-open:rotate-180" data-v-bb6d7070>▲</span></summary><div class="mt-2 px-4 text-gray-600" data-v-bb6d7070> Ao acessar o link você será redirecionado para a página do Amazon Kindle. Após a compra estará disponível em sua biblioteca. </div></details><details class="group" data-v-bb6d7070><summary class="flex justify-between items-center p-4 bg-white rounded-lg shadow-md cursor-pointer text-lg font-medium group-hover:bg-gray-50" data-v-bb6d7070> Posso acessar o ebook no celular? <span class="transition-transform transform group-open:rotate-180" data-v-bb6d7070>▲</span></summary><div class="mt-2 px-4 text-gray-600" data-v-bb6d7070> Sim! O e-book está em formato kindle e pode ser acessado em qualquer dispositivo, incluindo celulares, tablets e computadores. Só baixar o app! </div></details><details class="group" data-v-bb6d7070><summary class="flex justify-between items-center p-4 bg-white rounded-lg shadow-md cursor-pointer text-lg font-medium group-hover:bg-gray-50" data-v-bb6d7070> O conteúdo é indicado para iniciantes? <span class="transition-transform transform group-open:rotate-180" data-v-bb6d7070>▲</span></summary><div class="mt-2 px-4 text-gray-600" data-v-bb6d7070> Sim! O e-book cobre desde os fundamentos básicos até técnicas avançadas de SEO, ideal para todos os níveis. </div></details><details class="group" data-v-bb6d7070><summary class="flex justify-between items-center p-4 bg-white rounded-lg shadow-md cursor-pointer text-lg font-medium group-hover:bg-gray-50" data-v-bb6d7070> O pagamento é seguro? <span class="transition-transform transform group-open:rotate-180" data-v-bb6d7070>▲</span></summary><div class="mt-2 px-4 text-gray-600" data-v-bb6d7070> Claro! A transação é processada por uma plataforma confiável, garantindo segurança em todas as etapas do pagamento. </div></details></div></section><footer class="py-16 text-center bg-blue-600 text-white" data-v-bb6d7070><h2 class="text-4xl font-bold" data-v-bb6d7070>Pronto para alavancar seus resultados?</h2><p class="mt-4 text-lg" data-v-bb6d7070> Clique no botão abaixo e adquira agora mesmo seu e-book! </p><a${ssrRenderAttr("href", paymentLink)} class="mt-8 inline-block px-8 py-4 bg-white text-blue-600 font-bold rounded-lg shadow-lg text-lg hover:bg-gray-200 hover:scale-105 transition transform" data-v-bb6d7070> Comprar Agora por R$ ${ssrInterpolate(price)}</a></footer></div><!--]-->`);
    };
  }
});
...
const GuideSeo = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-bb6d7070"]]);
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: _sfc_main$a }, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></header><div class="mt-2 font-semibold text-md text-gray-700"><p>${__props.post.subtitle ?? ""}</p></div><div class="mt-6 prose max-w-none text-gray-800"><p>${__props.post.content ?? ""}</p></div><footer class="mt-8 text-sm text-gray-500"><strong>Tags:</strong> ${ssrInterpolate(__props.post.tags)}</footer></article></div><!--]-->`);
    };
  }
});
